    ...
    try:
        with open(file_path, 'r') as f:
            ...
            for row in reader:
                ...
                rev = float(row['Product_Price']) * int(row['Quantity'])
                if month in revenue:
                    revenue[month] += rev
                else:
                    revenue[month] = rev
        ...
        for k, v in revenue.items():
            month_num = datetime.strptime(str(k),"%m")
            month_name = month_num.strftime("%B")
            print(f"Month: {month_name}, Total Revenue generated in each month: {round(v,2)}")
...
def calculate_revenue_by_product(file_path):
    ...
    try:
        ...
        for k, v in revenue.items():
            print(f"Product Name: {k}, Total Revenue generated by product: {round(v,2)}")
...
def calculate_customer_revenue(file_path):
    ...
    try:
        ...
        for k, v in revenue.items():
            print(f"Customer ID: {k}, Total Revenue generated by customer: {round(v,2)}")
